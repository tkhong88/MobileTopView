...
struct MOBILETOPVIEW_API FSkelMeshMergeSectionMapping_BP
{
    GENERATED_BODY()
...
*/
USTRUCT(BlueprintType)
struct MOBILETOPVIEW_API FSkelMeshMergeUVTransform
{
    GENERATED_BODY()
...
*/
USTRUCT(BlueprintType)
struct MOBILETOPVIEW_API FSkelMeshMergeUVTransformMapping
{
    GENERATED_BODY()
...
*/
USTRUCT(BlueprintType)
struct MOBILETOPVIEW_API FSkeletalMeshMergeParams
{
    GENERATED_BODY()
...
*/
UCLASS()
class MOBILETOPVIEW_API UMeshMergeFunctionLibrary : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
public:
    /**
